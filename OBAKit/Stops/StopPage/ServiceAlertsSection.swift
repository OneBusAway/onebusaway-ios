...
struct ServiceAlertsSection: View {
    ...
    private var showAllRow: some View {
        Button {
            ...
            Text(CountPlural.format("stop_page.service_alerts.show_all_fmt", value: "Show all %d alerts", comment: "Row that expands the service alerts section to show every alert. %d is the total number of alerts. Plural forms live in Localizable.stringsdict; the value above is only the not-found fallback.", count: alerts.count))
                .font(.subheadline.weight(.semibold))
    ...
    private var headerAccessibilityLabel: String {
        CountPlural.format("stop_page.service_alerts.summary_fmt", value: "%d service alerts", comment: "Collapsed summary row for the service alerts section. %d is the number of alerts. Plural forms live in Localizable.stringsdict; the value above is only the not-found fallback.", count: alerts.count)
    }
