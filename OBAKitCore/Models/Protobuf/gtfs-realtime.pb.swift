...
struct TransitRealtime_TripUpdate: SwiftProtobuf.ExtensibleMessage, Sendable {
  ...
  var tripProperties: TransitRealtime_TripUpdate.TripProperties {
    get {return _tripProperties ?? TransitRealtime_TripUpdate.TripProperties()}
    set {_tripProperties = newValue}
  }
  /// Returns true if `tripProperties` has been explicitly set.
  var hasTripProperties: Bool {return self._tripProperties != nil}
...
extension TransitRealtime_TripUpdate.StopTimeUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}stop_sequence\0\u{1}arrival\0\u{1}departure\0\u{3}stop_id\0\u{3}schedule_relationship\0\u{3}stop_time_properties\0")
...
extension TransitRealtime_TripUpdate.StopTimeUpdate.StopTimeProperties: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}assigned_stop_id\0")
