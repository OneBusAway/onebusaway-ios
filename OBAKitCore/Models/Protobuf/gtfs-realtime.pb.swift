...
public struct TransitRealtime_Alert: SwiftProtobuf.ExtensibleMessage {
  ...
  public var ttsHeaderText: TransitRealtime_TranslatedString {
    get {return _storage._ttsHeaderText ?? TransitRealtime_TranslatedString()}
    set {_uniqueStorage()._ttsHeaderText = newValue}
  }
  /// Returns true if `ttsHeaderText` has been explicitly set.
  public var hasTtsHeaderText: Bool {return _storage._ttsHeaderText != nil}
  /// Clears the value of `ttsHeaderText`. Subsequent reads from it will return its default value.
  public mutating func clearTtsHeaderText() {_uniqueStorage()._ttsHeaderText = nil}

  /// Text for full description for the alert to be used in text-to-speech implementations. This field is the text-to-speech version of description_text.
  /// This field is still experimental, and subject to change. It may be formally adopted in the future.
  public var ttsDescriptionText: TransitRealtime_TranslatedString {
    get {return _storage._ttsDescriptionText ?? TransitRealtime_TranslatedString()}
    set {_uniqueStorage()._ttsDescriptionText = newValue}
  }
  /// Returns true if `ttsDescriptionText` has been explicitly set.
  public var hasTtsDescriptionText: Bool {return _storage._ttsDescriptionText != nil}
  /// Clears the value of `ttsDescriptionText`. Subsequent reads from it will return its default value.
  public mutating func clearTtsDescriptionText() {_uniqueStorage()._ttsDescriptionText = nil}

  public var severityLevel: TransitRealtime_Alert.SeverityLevel {
    get {return _storage._severityLevel ?? .unknownSeverity}
    set {_uniqueStorage()._severityLevel = newValue}
  }
  /// Returns true if `severityLevel` has been explicitly set.
  public var hasSeverityLevel: Bool {return _storage._severityLevel != nil}
  /// Clears the value of `severityLevel`. Subsequent reads from it will return its default value.
  public mutating func clearSeverityLevel() {_uniqueStorage()._severityLevel = nil}
...
public struct TransitRealtime_EntitySelector: SwiftProtobuf.ExtensibleMessage {
  ...
  /// Returns true if `directionID` has been explicitly set.
  public var hasDirectionID: Bool {return _storage._directionID != nil}
  /// Clears the value of `directionID`. Subsequent reads from it will return its default value.
  public mutating func clearDirectionID() {_uniqueStorage()._directionID = nil}
...
extension TransitRealtime_Alert: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _ttsHeaderText: TransitRealtime_TranslatedString? = nil
    var _ttsDescriptionText: TransitRealtime_TranslatedString? = nil
    var _severityLevel: TransitRealtime_Alert.SeverityLevel? = nil
    ...
    init(copying source: _StorageClass) {
      ...
      _ttsHeaderText = source._ttsHeaderText
      _ttsDescriptionText = source._ttsDescriptionText
      _severityLevel = source._severityLevel
    }
  }
  ...
  public var isInitialized: Bool {
    ...
    return withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._ttsHeaderText, !v.isInitialized {return false}
      if let v = _storage._ttsDescriptionText, !v.isInitialized {return false}
      return true
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 12: try decoder.decodeSingularMessageField(value: &_storage._ttsHeaderText)
        case 13: try decoder.decodeSingularMessageField(value: &_storage._ttsDescriptionText)
        case 14: try decoder.decodeSingularEnumField(value: &_storage._severityLevel)
        case 1000..<2000, 9000..<10000:
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._ttsHeaderText {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
      }
      if let v = _storage._ttsDescriptionText {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 13)
      }
      if let v = _storage._severityLevel {
  ...
  public static func ==(lhs: TransitRealtime_Alert, rhs: TransitRealtime_Alert) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._ttsHeaderText != rhs_storage._ttsHeaderText {return false}
        if _storage._ttsDescriptionText != rhs_storage._ttsDescriptionText {return false}
        if _storage._severityLevel != rhs_storage._severityLevel {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
...
extension TransitRealtime_EntitySelector: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    init(copying source: _StorageClass) {
      ...
      _trip = source._trip
      _stopID = source._stopID
      _directionID = source._directionID
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 6: try decoder.decodeSingularUInt32Field(value: &_storage._directionID)
        case 1000..<2000, 9000..<10000:
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if let v = _storage._directionID {
        try visitor.visitSingularUInt32Field(value: v, fieldNumber: 6)
      }
      try visitor.visitExtensionFields(fields: _protobuf_extensionFieldValues, start: 1000, end: 2000)
      try visitor.visitExtensionFields(fields: _protobuf_extensionFieldValues, start: 9000, end: 10000)
  ...
  public static func ==(lhs: TransitRealtime_EntitySelector, rhs: TransitRealtime_EntitySelector) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._trip != rhs_storage._trip {return false}
        if _storage._stopID != rhs_storage._stopID {return false}
        if _storage._directionID != rhs_storage._directionID {return false}
        return true
      }
      if !storagesAreEqual {return false}
    }
